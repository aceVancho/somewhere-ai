...
//       try {
//         sectionsResponse = await splitChain.invoke('');
//       } catch (error) {
...
//         Responses must be in JSON format. {scoresFormatInstructions}
//       `;
...
//         // const sentimentOptions = { format_instructions: '{ scores: string[] }' };
//         const sentimentChain = sentimentPrompt.pipe(llm);
//         const scoresFormatInstructions = '{ scores: string[] }'
    
//         let sentimentResponse;
//         try {
//           sentimentResponse = await sentimentChain.invoke({ scoresFormatInstructions });
